package com.example.signalrecord;
...
import com.example.signalrecord.adapter.BlueListAdapter;
import com.example.signalrecord.bean.BlueDevice;
import com.example.signalrecord.task.BlueAcceptTask;
import com.example.signalrecord.task.BlueConnectTask;
import com.example.signalrecord.task.BlueReceiveTask;
import com.example.signalrecord.util.BluetoothUtil;
import com.example.signalrecord.widget.InputDialogFragment;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l_layout = (LinearLayout) findViewById(R.id.linear_layout);
    ...
    private void bluetoothPermissions() {
        ...
        ActivityCompat.requestPermissions(this, new String[]{
                android.Manifest.permission.BLUETOOTH}, 1);
        /*ActivityCompat.requestPermissions(this, new String[]{
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        Log.v("WARN", String.valueOf(grantResults[0]));
        Log.v("WARN", String.valueOf(PackageManager.PERMISSION_GRANTED));
    ...
    public void onClick(View v) {
        ...
        Log.v("TAG", String.valueOf(R.id.tv_discovery));
